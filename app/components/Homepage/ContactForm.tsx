      ...
      <div className="relative">
        ...
        >
          <div className="text-center md:max-w-[446px] mx-auto">
            <h2 className="text-[#F5F5F5] text-[32px] lg:text-[42px] font-gobold leading-[44.8px] lg:leading-[63.2px]">
              REACH OUT TO US!
            </h2>
            <p className="text-[#DCDCDC] font-aeoniklight mt-[10px] text-[16px] leading-[27px] tracking-[-3%]">
          ...
          <form className="md:mt-[36px] mt-[52px] space-y-[36px]">
            <input
              type="text"
              className="bg-[#2B2B2B] rounded-[12px] w-full px-[20px] pt-[17px] pb-[21px] text-[16px] text-[#ACACAC] font-aeoniklight leading-[21.6px] focus:outline-none"
            ...
            />
            <textarea
              className="bg-[#2B2B2B] rounded-[12px] w-full px-[20px] pt-[17px] pb-[21px] text-[16px] text-[#ACACAC] font-aeoniklight leading-[21.6px] focus:outline-none h-[172px]"
