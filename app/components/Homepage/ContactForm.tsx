    ...
    <div className="w-full">
      <div className="relative">
        ...
        <motion.div
          ...
          className="absolute md:w-[800px] py-[60px] w-[361px] px-[16px] md:px-[80px] top-[80px] md:top-[100px] bottom-[80px] md:bottom-[100px] h-[834px] lg:h-auto rounded-[12px] left-0 right-0 my-auto mx-auto bg-black z-10"
        >
          <div className="text-center md:max-w-[446px] mx-auto">
            <h2 className="text-[#F5F5F5] text-[32px] lg:text-[64px] font-gobold leading-[44.8px] lg:leading-[83.2px]">
              REACH OUT TO US!
            </h2>
          ...
          <form className="md:mt-[56px] mt-[52px] space-y-[36px]">
            <input
              type="text"
